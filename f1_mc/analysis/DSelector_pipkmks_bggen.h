#ifndef DSelector_pipkmks_bggen_h
#define DSelector_pipkmks_bggen_h
...
class DSelector_pipkmks_bggen : public DSelector
{
	public:

		DSelector_pipkmks_bggen(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_pipkmks_bggen(){}
...
// DEFINE YOUR HISTOGRAMS HERE
	...
	ClassDef(DSelector_pipkmks_bggen, 0);
};

void DSelector_pipkmks_bggen::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_pipkmks_bggen_h
