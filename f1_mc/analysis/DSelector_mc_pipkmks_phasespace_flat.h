#ifndef DSelector_mc_pipkmks_phasespace_flat_h
#define DSelector_mc_pipkmks_phasespace_flat_h
...
class DSelector_mc_pipkmks_phasespace_flat : public DSelector
{
	public:

		DSelector_mc_pipkmks_phasespace_flat(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_mc_pipkmks_phasespace_flat(){}
	...
	ClassDef(DSelector_mc_pipkmks_phasespace_flat, 0);
};

void DSelector_mc_pipkmks_phasespace_flat::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_mc_pipkmks_phasespace_flat_h
