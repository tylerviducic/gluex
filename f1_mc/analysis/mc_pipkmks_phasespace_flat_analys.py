...
filename = f'/w/halld-scshelf2101/home/viducic/selector_output/f1_flat/mc_pipkmks_flat_phasespace_bestX2_{run_period}.root'
...
# data_mc_comparison_df.Snapshot(f'mc_pipkmks_signal_filtered_{run_period_dict[run_period]}', f'/w/halld-scshelf2101/home/viducic/selector_output/f1_flat/mc_pipkmks_signal_filtered_{run_period_dict[run_period]}.root')

# UNCOMMENT FOR FULL MASS SPECTRUM FILTERED DATA 
df.Snapshot(f'mc_pipkmks_phasespace_filtered_{run_period_dict[run_period]}', f'/w/halld-scshelf2101/home/viducic/selector_output/f1_flat/mc_pipkmks_phasespace_filtered_{run_period_dict[run_period]}.root')
