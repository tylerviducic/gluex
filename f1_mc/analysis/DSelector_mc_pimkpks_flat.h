#ifndef DSelector_mc_pimkpks_flat_h
#define DSelector_mc_pimkpks_flat_h
...
class DSelector_mc_pimkpks_flat : public DSelector
{
	public:

		DSelector_mc_pimkpks_flat(TTree* locTree = NULL) : DSelector(locTree){} 
		virtual ~DSelector_mc_pimkpks_flat(){}
	...
	ClassDef(DSelector_mc_pimkpks_flat, 0);
};

void DSelector_mc_pimkpks_flat::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_mc_pimkpks_flat_h
