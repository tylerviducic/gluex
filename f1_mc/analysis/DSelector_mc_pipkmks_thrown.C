...
void DSelector_mc_pipkmks_thrown::Init(TTree *locTree)
{
	...
	dFlatTreeFileName = "/volatile/halld/home/viducic/selector_output/f1_pipkmks/thrown/pipkmks_thrown_fall.root"; //output flat tree (one combo per tree entry), "" for none
