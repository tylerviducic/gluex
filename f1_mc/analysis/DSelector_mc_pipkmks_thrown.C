#include "DSelector_mc_pipkmks_thrown.h"

void DSelector_mc_pipkmks_thrown::Init(TTree *locTree)
{
	...
	dFlatTreeFileName = "/volatile/halld/home/viducic/selector_output/f1_pipkmks/thrown/pipkmks_thrown_spring.root"; //output flat tree (one combo per tree entry), "" for none
...
Bool_t DSelector_mc_pipkmks_thrown::Process(Long64_t locEntry)
{
...
void DSelector_mc_pipkmks_thrown::Finalize(void)
{
