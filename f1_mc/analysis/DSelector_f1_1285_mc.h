#ifndef DSelector_f1_1285_mc_h
#define DSelector_f1_1285_mc_h
...
class DSelector_f1_1285_mc : public DSelector
{
	public:

		DSelector_f1_1285_mc(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_f1_1285_mc(){}
	...
	ClassDef(DSelector_f1_1285_mc, 0);
};

void DSelector_f1_1285_mc::Get_ComboWrappers(void)
{
	//Step 0
