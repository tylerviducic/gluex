#include "DSelector_pipkmks_flat_bestchi2.h"

void DSelector_pipkmks_flat_bestchi2::Init(TTree *locTree)
{
...
Bool_t DSelector_pipkmks_flat_bestchi2::Process(Long64_t locEntry)
{
...
void DSelector_pipkmks_flat_bestchi2::Finalize(void)
{
