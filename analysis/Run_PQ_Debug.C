void Run_PQ_Debug(){
    ...
    gROOT->ProcessLine("ch->Add(\"/cache/halld/RunPeriod-2018-01/analysis/ver16/tree_pipkmks__B4_M16/merged/tree_pipkmks__B4_M16_0425*.root\")");
    ...
    gROOT->ProcessLine("DPROOFLiteManager::Process_Chain(ch, \"DSelector_pq.C+\", 4)");
}