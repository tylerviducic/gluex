...
void Debug_PimKpKs_Flat(){

    gROOT->ProcessLine("TChain* ch = new TChain(\"pimkpks__B4_M16_Tree\")");
    gROOT->ProcessLine("ch->Add(\"/cache/halld/RunPeriod-2018-01/analysis/ver03/tree_pimkpks__B4_M16/merged/tree_pimkpks__B4_M16_04255*.root\")");
    ...
    gROOT->ProcessLine("DPROOFLiteManager::Process_Chain(ch, \"DSelector_pimkpks_flat_bestchi2.C+\", 4)");
}
