#include "DSelector_pipkmks_pd_unconstrained.h"

void DSelector_pipkmks_pd_unconstrained::Init(TTree *locTree)
{
	...
	dFlatTreeFileName = "pipkmks_pd_unconstrained.root"; // output flat tree (one combo per tree entry), "" for none
...
Bool_t DSelector_pipkmks_pd_unconstrained::Process(Long64_t locEntry)
{
...
void DSelector_pipkmks_pd_unconstrained::Finalize(void)
{
