#ifndef DSelector_pipkmks_flat_2019_ks_constrained_t1_s2_h
#define DSelector_pipkmks_flat_2019_ks_constrained_t1_s2_h
...
class DSelector_pipkmks_flat_2019_ks_constrained_t1_s2 : public DSelector
{
	public:

		DSelector_pipkmks_flat_2019_ks_constrained_t1_s2(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_pipkmks_flat_2019_ks_constrained_t1_s2(){}
	...
	ClassDef(DSelector_pipkmks_flat_2019_ks_constrained_t1_s2, 0);
};

void DSelector_pipkmks_flat_2019_ks_constrained_t1_s2::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_pipkmks_flat_2019_ks_constrained_t1_s2_h
