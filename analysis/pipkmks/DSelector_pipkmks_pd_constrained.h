#ifndef DSelector_pipkmks_pd_constrained_h
#define DSelector_pipkmks_pd_constrained_h
...
class DSelector_pipkmks_pd_constrained : public DSelector
{
	public:

		DSelector_pipkmks_pd_constrained(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_pipkmks_pd_constrained(){}
	...
	ClassDef(DSelector_pipkmks_pd_constrained, 0);
};

void DSelector_pipkmks_pd_constrained::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_pipkmks_pd_constrained_h
