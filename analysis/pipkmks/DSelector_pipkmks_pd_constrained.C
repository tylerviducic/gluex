#include "DSelector_pipkmks_pd_constrained.h"

void DSelector_pipkmks_pd_constrained::Init(TTree *locTree)
{
...
Bool_t DSelector_pipkmks_pd_constrained::Process(Long64_t locEntry)
{
...
void DSelector_pipkmks_pd_constrained::Finalize(void)
{
