#include "DSelector_pipkmks_mxp_constrained.h"

void DSelector_pipkmks_mxp_constrained::Init(TTree *locTree)
{
	...
	dFlatTreeFileName = "pipkmks_mxp_constrained.root"; // output flat tree (one combo per tree entry), "" for none
...
Bool_t DSelector_pipkmks_mxp_constrained::Process(Long64_t locEntry)
{
...
void DSelector_pipkmks_mxp_constrained::Finalize(void)
{
