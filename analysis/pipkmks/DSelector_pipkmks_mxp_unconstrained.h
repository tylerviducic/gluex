#ifndef DSelector_pipkmks_mxp_unconstrained_h
#define DSelector_pipkmks_mxp_unconstrained_h
...
class DSelector_pipkmks_mxp_unconstrained : public DSelector
{
	public:

		DSelector_pipkmks_mxp_unconstrained(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_pipkmks_mxp_unconstrained(){}
	...
	ClassDef(DSelector_pipkmks_mxp_unconstrained, 0);
};

void DSelector_pipkmks_mxp_unconstrained::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_pipkmks_mxp_unconstrained_h
