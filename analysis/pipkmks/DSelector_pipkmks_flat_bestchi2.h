#ifndef DSelector_pipkmks_flat_bestchi2_h
#define DSelector_pipkmks_flat_bestchi2_h
...
class DSelector_pipkmks_flat_bestchi2 : public DSelector
{
	public:

		DSelector_pipkmks_flat_bestchi2(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_pipkmks_flat_bestchi2(){}
	...
	ClassDef(DSelector_pipkmks_flat_bestchi2, 0);
};

void DSelector_pipkmks_flat_bestchi2::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_pipkmks_flat_bestchi2_h
