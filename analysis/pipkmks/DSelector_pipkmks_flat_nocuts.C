#include "DSelector_pipkmks_flat_nocuts.h"

void DSelector_pipkmks_flat_nocuts::Init(TTree *locTree)
{
	...
	dFlatTreeFileName = "pipkmks_flat_bestX2"; //output flat tree (one combo per tree entry), "" for none
...
Bool_t DSelector_pipkmks_flat_nocuts::Process(Long64_t locEntry)
{
	...
	*/
	...
	dFlatTreeInterface->Fill_Fundamental<Double_t>("pip1_px", LocPiPlus1_P4.Px());
	dFlatTreeInterface->Fill_Fundamental<Double_t>("pip1_py", LocPiPlus1_P4.Py());
	dFlatTreeInterface->Fill_Fundamental<Double_t>("pip1_pz", locPiPlus1_P4.Pz()); 
	dFlatTreeInterface->Fill_Fundamental<Double_t>("pip1_E", locPiPlus1_P4.E()); 
	
	dFlatTreeInterface->Fill_Fundamental<Double_t>("pip2_px", LocPiPlus2_P4.Px()); 
	dFlatTreeInterface->Fill_Fundamental<Double_t>("pip2_py", locPiPlus2_P4.Py()); 
	dFlatTreeInterface->Fill_Fundamental<Double_t>("pip2_pz", locPiPlus2_P4.Pz()); 
	dFlatTreeInterface->Fill_Fundamental<Double_t>("pip2_E", locPiPlus2_P4.E()); 
	
	dFlatTreeInterface->Fill_Fundamental<Double_t>("pim_px", locPiMinus_P4.Px()); 
	dFlatTreeInterface->Fill_Fundamental<Double_t>("pim_py", locPiMinus_P4.Py()); 
	dFlatTreeInterface->Fill_Fundamental<Double_t>("pim_pz", locPiMinus_P4.Pz()); 
	dFlatTreeInterface->Fill_Fundamental<Double_t>("pim_E", locPiMinus_P4.E()); 
	
	dFlatTreeInterface->Fill_Fundamental<Double_t>("km_px", locKMinus_P4.Px()); 
	dFlatTreeInterface->Fill_Fundamental<Double_t>("km_py", locKMinus_P4.Py()); 
	dFlatTreeInterface->Fill_Fundamental<Double_t>("km_pz", locKMinus_P4.Pz());
	dFlatTreeInterface->Fill_Fundamental<Double_t>("km_E", locKMinus_P4.E()); 
	
	dFlatTreeInterface->Fill_Fundamental<Double_t>("p_px", locProton_P4.Px()); 
	dFlatTreeInterface->Fill_Fundamental<Double_t>("p_py", locProton_P4.Py()); 
	dFlatTreeInterface->Fill_Fundamental<Double_t>("p_pz", locProton_P4.Pz()); 
	dFlatTreeInterface->Fill_Fundamental<Double_t>("p_E", locProton_P4.E()); 
	...
	dFlatTreeInterface->Fill_Fundamental<Double_t>("vertex_difference", vertex_distance_Ks);
...
void DSelector_pipkmks_flat_nocuts::Finalize(void)
{
