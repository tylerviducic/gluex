#ifndef DSelector_pipkmks_pd_unconstrained_h
#define DSelector_pipkmks_pd_unconstrained_h
...
class DSelector_pipkmks_pd_unconstrained : public DSelector
{
	public:

		DSelector_pipkmks_pd_unconstrained(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_pipkmks_pd_unconstrained(){}
	...
	ClassDef(DSelector_pipkmks_pd_unconstrained, 0);
};

void DSelector_pipkmks_pd_unconstrained::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_pipkmks_pd_unconstrained_h
