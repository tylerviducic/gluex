#ifndef DSelector_pimkpks_flat_bestchi2_h
#define DSelector_pimkpks_flat_bestchi2_h
...
class DSelector_pimkpks_flat_bestchi2 : public DSelector
{
	public:

		DSelector_pimkpks_flat_bestchi2(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_pimkpks_flat_bestchi2(){}
	...
	ClassDef(DSelector_pimkpks_flat_bestchi2, 0);
};

void DSelector_pimkpks_flat_bestchi2::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_pimkpks_flat_bestchi2_h
