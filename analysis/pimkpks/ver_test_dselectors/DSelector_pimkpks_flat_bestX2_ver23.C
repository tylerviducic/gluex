#include "DSelector_pimkpks_flat_bestX2_ver23.h"

void DSelector_pimkpks_flat_bestX2_ver23::Init(TTree *locTree)
{
	...
	dFlatTreeFileName = "pimkpks_flat_bestX2_ver23.root"; //output flat tree (one combo per tree entry), "" for none
...
Bool_t DSelector_pimkpks_flat_bestX2_ver23::Process(Long64_t locEntry)
{
...
void DSelector_pimkpks_flat_bestX2_ver23::Finalize(void)
{
