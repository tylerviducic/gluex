...
class DSelector_f1_analysis : public DSelector
{
	...
	private:
		...
		TH2F* dHist_KsPip_KmPip_Dalitz_1100_1350;
		TH2F* dHist_KsPip_KmPip_Dalitz_1350_1500;
		TH2F* dHist_KsPip_KmPip_Dalitz_1500;
		TH2F* dHist_KsPip_vs_PipKmKs;
		TH2F* dHist_KsKm_vs_PipKmKs;
		TH2F* dHist_KmPip_vs_PipKmKs;
