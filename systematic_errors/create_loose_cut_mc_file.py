...
df_pimkpks_spring = tools.get_dataframe('pimkpks', 'spring', 'signal', filtered=False)
df_pipkmks_spring = tools.get_dataframe('pipkmks', 'spring', 'signal', filtered=False)
df_pipkmks_fall = tools.get_dataframe('pipkmks', 'fall', 'signal', filtered=False)
df_pimkpks_fall = tools.get_dataframe('pimkpks', 'fall', 'signal', filtered=False)
df_pipkmks_2017 = tools.get_dataframe('pipkmks', '2017', 'signal', filtered=False)
df_pimkpks_2017 = tools.get_dataframe('pimkpks', '2017', 'signal', filtered=False)

for cut in varied_cuts_dict_pipkmks:
    df_pipkmks_spring = df_pipkmks_spring.Filter(varied_cuts_dict_pipkmks[cut][0])
    df_pimkpks_spring = df_pimkpks_spring.Filter(varied_cuts_dict_pimkpks[cut][0])
    df_pipkmks_fall = df_pipkmks_fall.Filter(varied_cuts_dict_pipkmks[cut][0])
    df_pimkpks_fall = df_pimkpks_fall.Filter(varied_cuts_dict_pimkpks[cut][0])
    df_pipkmks_2017 = df_pipkmks_2017.Filter(varied_cuts_dict_pipkmks[cut][0])
    df_pimkpks_2017 = df_pimkpks_2017.Filter(varied_cuts_dict_pimkpks[cut][0])
...
df_pipkmks_spring.Snapshot('pipkmks_loose', f'{output_path_pipkmks}/pipkmks_loose_spring.root')
df_pimkpks_spring.Snapshot('pimkpks_loose', f'{output_path_pimkpks}/pimkpks_loose_spring.root')
df_pipkmks_fall.Snapshot('pipkmks_loose', f'{output_path_pipkmks}/pipkmks_loose_fall.root')
df_pimkpks_fall.Snapshot('pimkpks_loose', f'{output_path_pimkpks}/pimkpks_loose_fall.root')
df_pipkmks_2017.Snapshot('pipkmks_loose', f'{output_path_pipkmks}/pipkmks_loose_2017.root')
df_pimkpks_2017.Snapshot('pimkpks_loose', f'{output_path_pimkpks}/pimkpks_loose_2017.root')
