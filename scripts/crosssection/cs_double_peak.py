# script for fitting and extracting the yield and cross section for both 
# f1 peaks without a selection cut on etiher peak
...
thrown_filename_fall = f'/Users/tylerviducic/research/gluex/selector_output/pipkmks_t_binned_thrown_0_2_{beam_energy}_fall.root'
thrown_filename_spring = f'/Users/tylerviducic/research/gluex/selector_output/pipkmks_t_binned_thrown_0_2_{beam_energy}_spring.root'
...
energy_values_low = ['0.100', '0.200', '0.300', '0.400'] #'0.100', '0.150', '0.200',  
energy_values_med = ['0.650', '0.900']
energy_values_high = ['1.400', '1.900']#, '1.700', '1.900']
...
for x in range(len(data_histogram_array)):
    ...
    func = ROOT.TF1(f"func_{x}", full_fit, fit_start, fit_end, 9)
