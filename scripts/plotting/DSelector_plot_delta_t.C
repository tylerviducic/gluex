#include "DSelector_plot_delta_t.h"

void DSelector_plot_delta_t::Init(TTree *locTree)
{
	...
	dOutputFileName = "plot_delta_t.root"; //"" for none
...
Bool_t DSelector_plot_delta_t::Process(Long64_t locEntry)
{
	...
	*/
	...
	for(UInt_t loc_i = 0; loc_i < Get_NumCombos(); ++loc_i)
	{
		...
		// if (locRelBeamBucket == 0){ // Skip out-of-time events
		// 	dHist_RFTimeCut->Fill(locDeltaT_RF);
		// }
...
void DSelector_plot_delta_t::Finalize(void)
{
