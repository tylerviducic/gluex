...
df = df.Define('ks_px_thrown', 'pip1_px_thrown + pip2_px_thrown')
df = df.Define('ks_py_thrown', 'pip1_py_thrown + pip2_py_thrown')
df = df.Define('ks_pz_thrown', 'pip1_pz_thrown + pip2_pz_thrown')
df = df.Define('ks_E_thrown', 'pip1_E_thrown + pip2_E_thrown')
...
hist_ks_thrown = df.Histo1D(('ks_thrown', 'ks_thrown', 100, 0.0, 1.0), 'ks_m_thrown')
...
# hist_r_t.Draw()
# c.cd(2)
# hist_recon.Draw("HIST")
# hist_thrown.Draw('same HIST')
# hist_km_double.Draw()
