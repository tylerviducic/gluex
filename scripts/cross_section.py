# Calculate the cross section for f1_1285 
...
thrown_filename_fall = f'/Users/tylerviducic/research/gluex/f1_mc/analysis/pipkmks_t_binned_thrown_0_2_{beam_energy}_fall.root'
thrown_filename_spring = f'/Users/tylerviducic/research/gluex/f1_mc/analysis/pipkmks_t_binned_thrown_0_2_{beam_energy}_spring.root'
data_filename = '/Users/tylerviducic/research/gluex/selector_output/pipkmks_2018_full.root'
...
param_dict = {
    7: [27.5543, 1.285, 0.03, -40.9782, 3.01286e+01,  -7.69889],
    8: [62.5121, 1.285, 0.03, -27.4961, 32.2702,  -8.28696],
    9: [55.6267, 1.285, 0.03, -30.131, 34.9381, -8.94178],
    10: [48, 1.285, 0.03, -2.89764e+01, 3.34119e+01, -8.61501],
}
...
for x in range(len(data_histogram_array)):
    ...
    func = ROOT.TF1(f"func_{x}", full_fit, fit_start, fit_end, 6)
...
# theory_4 = theory_df[theory_df['minus_t'] == 0.4]['diff_cs']
# cs_4 = diff_cs[3]
# norm_factor = cs_4 / theory_4
# # print(theory_df)
# print(norm_factor)
# theory_df['diff_cs'] = theory_df['diff_cs'] * norm_factor
# print(theory_df)
...
csv_filename = f'cs_dataframe_{beam_energy}.csv'
...
ax1.set_yscale('log')
ax1.set_xlim([0.25, 1.6])
ax1.set_ylim([1000, 1e6])

# fig = plt.figure()
# ax6 = fig.add_subplot(111) 
# ax6.errorbar(bin_values, diff_cs, yerr=diff_cs_error, xerr=[x/2 for x in bin_width], fmt='o', ls='none', color='red')
# # ax1.errorbar(bin_values, integral_values_1420, yerr=error_values_1420,fmt='o', ls='none', color='black')
# #ax1.errorbar(bin_values, integral_values_1285, fmt='o', ls='none', color='red')
# ax6.scatter(theory_df['minus_t'], theory_df['diff_cs'], marker='o' ,color='blue', s=3)
# ax6.set_ylabel("differential cross section [pb/GeV]")
# ax6.set_xlabel("-t (GeV)^2")
# # ax1.set_title("N(f1(1285)) vs W (GeV)")
# ax6.set_title("differential cross-section [pb]/GeV vs -t (GeV^2)")
# # ax1.set_yscale('log')
# ax6.set_xlim([0.25, 1.6])
