# script to compare the yields of 1200 region with and without kstar cut
...
# data_filename = f'/Users/tylerviducic/research/gluex/selector_output/{topology}_flat_result_2018_full_kstar_zero_cut.root'
...
param_dict = {
    ...
    7: [27.5543, 1.285, 0.0227, 100, 1.420, 0.0545, 10, 10, 10],
    8: [62.5121, 1.285, 0.0227, 200, 1.420, 0.0545, 0.1, 0.1, 0.1],
...
for x in range(len(data_histogram_array)):
    ...
    func = ROOT.TF1(f"func_{x}", full_fit_double, fit_start, fit_end, 9)
...
csv_filename = f'/Users/tylerviducic/research/gluex/fit_csv/cs_dataframe_{beam_energy}_{topology}_kstar_zero_cut.csv'
