#include "DSelector_acceptance_study_pipkmks_thrown.h"

void DSelector_acceptance_study_pipkmks_thrown::Init(TTree *locTree)
{
	...
	dOutputFileName = "acceptance_study_pipkmks_thrown.root"; //"" for none
	...
	dFlatTreeFileName = "acceptance_study_pipkmks_thrown_flat.root"; //output flat tree (one combo per tree entry), "" for none
...
Bool_t DSelector_acceptance_study_pipkmks_thrown::Process(Long64_t locEntry)
{
...
void DSelector_acceptance_study_pipkmks_thrown::Finalize(void)
{
