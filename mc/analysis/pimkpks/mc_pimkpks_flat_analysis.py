...
df.Snapshot(f'mc_pipkmks_filtered_{run_dict[run_period]}', f'/w/halld-scshelf2101/home/viducic/data/pipkmks/mc/signal/mc_pipkmks_filtered_{run_period_dict[run_period]}.root')
