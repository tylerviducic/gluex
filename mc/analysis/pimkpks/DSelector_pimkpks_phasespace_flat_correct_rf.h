#ifndef DSelector_pimkpks_phasespace_flat_correct_rf_h
#define DSelector_pimkpks_phasespace_flat_correct_rf_h
...
class DSelector_pimkpks_phasespace_flat_correct_rf : public DSelector
{
	public:

		DSelector_pimkpks_phasespace_flat_correct_rf(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_pimkpks_phasespace_flat_correct_rf(){}
	...
	ClassDef(DSelector_pimkpks_phasespace_flat_correct_rf, 0);
};

void DSelector_pimkpks_phasespace_flat_correct_rf::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_pimkpks_phasespace_flat_correct_rf_h
