...
void DSelector_mc_pimkpks_phasespace_thrown::Init(TTree *locTree)
{
	...
	dFlatTreeFileName = "/volatile/halld/home/viducic/selector_output/f1_pimkpks/thrown/pimkpks_phasespace_thrown_2018_fall.root"; // output flat tree (one combo per tree entry), "" for none
