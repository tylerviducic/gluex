...
void RunF1Phasespace_KsKpPim_CorrectRF(string filename){
    ...
    dproof->Process_Chain(ch, "/work/halld/home/viducic/mc/analysis/pimkpks/DSelector_pimkpks_phasespace_flat_correct_rf.C++", 6);
} 

    // gROOT->ProcessLine("TChain* ch = new TChain(\"pimkpks__ks_pippim__B4_M16_Tree\")");
    // // gROOT->ProcessLine("ch->Add(\"/lustre19/expphy/volatile/halld/home/viducic/pimkpks_mc/phasespace/combined_runs/tree_pimkpks__ks_pippim__B4_M16_03*.root\")"); // 2017
    // // gROOT->ProcessLine("ch->Add(\"/lustre19/expphy/volatile/halld/home/viducic/pimkpks_mc/phasespace/combined_runs/tree_pimkpks__ks_pippim__B4_M16_04*.root\")"); // spring 2018
    // gROOT->ProcessLine("ch->Add(\"/lustre19/expphy/volatile/halld/home/viducic/pimkpks_mc/phasespace/combined_runs/tree_pimkpks__ks_pippim__B4_M16_05*.root\")"); // fall 2018
    // gROOT->ProcessLine(".x $ROOT_ANALYSIS_HOME/scripts/Load_DSelector.C");
    // gROOT->ProcessLine("DPROOFLiteManager::Process_Chain(ch, \"DSelector_pimkpks_phasespace_flat_correct_rf.C++\", 6)");
