#include "DSelector_pipkmks_bggen.h"

void DSelector_pipkmks_bggen::Init(TTree *locTree)
{
	...
	dOutputFileName = "pipkmks_bggen_batch04.root"; //"" for none
...
Bool_t DSelector_pipkmks_bggen::Process(Long64_t locEntry)
{
...
void DSelector_pipkmks_bggen::Finalize(void)
{
