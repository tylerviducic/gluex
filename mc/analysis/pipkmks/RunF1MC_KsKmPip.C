void RunF1MC_KsKmPip(){
    ...
    gROOT->ProcessLine("ch->Add(\"/lustre19/expphy/cache/halld/gluex_simulations/REQUESTED_MC/pimkpks_phasespace_s18_100m_v50_rt_t29_3252/root/trees/tree_pipkmks__ks_pippim__B4_M16_gen_amp/*.root\")"); // spring 18 phasespace 
    gROOT->ProcessLine(".x $ROOT_ANALYSIS_HOME/scripts/Load_DSelector.C");
