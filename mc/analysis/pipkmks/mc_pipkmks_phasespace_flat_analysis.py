...
target_file = ROOT.TFile(f"/w/halld-scshelf2101/home/viducic/selector_output/f1_flat/mc_pipkmks__phasespace_flat_result_{run_period_dict[run_period]}.root", 'RECREATE')
