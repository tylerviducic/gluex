...
void DSelector_mc_pipkmks_phasespace_flat::Init(TTree *locTree)
{
	...
	dFlatTreeFileName = "/work/halld/home/viducic/data/pipkmks/mc/phasespace/pipkmks_phasespace_flat_bestX2_2017.root"; //output flat tree (one combo per tree entry), "" for none
