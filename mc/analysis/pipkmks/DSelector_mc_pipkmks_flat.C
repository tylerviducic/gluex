...
void DSelector_mc_pipkmks_flat::Init(TTree *locTree)
{
	...
	dFlatTreeFileName = "/w/halld-scshelf2101/home/viducic/selector_output/f1_flat/mc_pipkmks_flat_bestX2_2018_spring.root"; //output flat tree (one combo per tree entry), "" for none
