...
void DSelector_mc_pipkmks_flat::Init(TTree *locTree)
{
	...
	dFlatTreeFileName = "/work/halld/home/viducic/data/pipkmks/mc/signal/pipkmks_flat_bestX2_2018_spring.root"; //output flat tree (one combo per tree entry), "" for none
