#include "DSelector_mc_pipkmks_recon.h"

void DSelector_mc_pipkmks_recon::Init(TTree *locTree)
{ 
	...
	dOutputFileName = "mc_pipkmks_recon_fall.root"; //"" for none
	...
	dHist_IM_KsKmPip = new TH1F("IM_KsKmPip", ";IM(Ks K- Pi+) GeV", 150, 1, 2.5);
	dHist_IM_KsKmPip_1285 = new TH1F("IM_KsKmPip_1285", ";IM(Ks K- Pi+) GeV", 150, 1, 2.5);
	dHist_IM_KsKmPip_1420 = new TH1F("IM_KsKmPip_1420", ";IM(Ks K- Pi+) GeV", 150, 1, 2.5);
	...
	for(int i = 0; i < 5; i++){
		...
		dHist_IM_KsKmPip_1285_binned[i] = new TH1F(hist_name1, hist_title, 150, 1, 2.5);
		dHist_IM_KsKmPip_1420_binned[i] = new TH1F(hist_name2, hist_title, 150, 1, 2.5);
		dHist_IM_KsKmPip_binned[i] = new TH1F(hist_name3, hist_title, 150, 1, 2.5);
		...
		dHist_f1_0_1285[i] = new TH1F(f1_1285, f1_hist_name, 150, 1, 2.5);
		dHist_f1_90_1285[i] = new TH1F(f2_1285, f1_hist_name, 150, 1, 2.5);
		dHist_f1_45_1285[i] = new TH1F(f3_1285, f1_hist_name, 150, 1, 2.5);
		dHist_f1_135_1285[i] = new TH1F(f4_1285, f1_hist_name, 150, 1, 2.5);
	...
	for(int i = 0; i < 5; i++){
		...
		dHist_W_binned_f1[i] = new TH1F(f1_hist_name, f1_hist_title, 150, 1, 2.5);
	}
	...
	for(int i = 0; i < 4; i++){
		...
		dHist_IM_KsKmPip_binned_full_low[i] = new TH1F(hist_name4, hist_title, 70, 1, 1.7);
		dHist_f1_1285_binned_full_low[i] = new TH1F(hist_name5, hist_title, 70, 1, 1.7);

		dHist_f1_1285_beam_5_low[i] = new TH1F(hist_name_b11, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_6_low[i] = new TH1F(hist_name_b12, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_7_low[i] = new TH1F(hist_name_b7, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_8_low[i] = new TH1F(hist_name_b8, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_9_low[i] = new TH1F(hist_name_b9, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_10_low[i] = new TH1F(hist_name_b10, hist_title, 70, 1, 1.7);
	...
	for(int i = 0; i < 2; i++){
		...
		dHist_IM_KsKmPip_binned_full_med[i] = new TH1F(hist_name4, hist_title, 70, 1, 1.7);
		dHist_f1_1285_binned_full_med[i] = new TH1F(hist_name5, hist_title, 70, 1, 1.7);

		dHist_f1_1285_beam_5_med[i] = new TH1F(hist_name_b11, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_6_med[i] = new TH1F(hist_name_b12, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_7_med[i] = new TH1F(hist_name_b7, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_8_med[i] = new TH1F(hist_name_b8, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_9_med[i] = new TH1F(hist_name_b9, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_10_med[i] = new TH1F(hist_name_b10, hist_title, 70, 1, 1.7);
	...
	for(int i = 0; i < 2; i++){
		...
		dHist_IM_KsKmPip_binned_full_high[i] = new TH1F(hist_name4, hist_title, 70, 1, 1.7);
		dHist_f1_1285_binned_full_high[i] = new TH1F(hist_name5, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_5_high[i] = new TH1F(hist_name_b11, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_6_high[i] = new TH1F(hist_name_b12, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_7_high[i] = new TH1F(hist_name_b7, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_8_high[i] = new TH1F(hist_name_b8, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_9_high[i] = new TH1F(hist_name_b9, hist_title, 70, 1, 1.7);
		dHist_f1_1285_beam_10_high[i] = new TH1F(hist_name_b10, hist_title, 70, 1, 1.7);
...
Bool_t DSelector_mc_pipkmks_recon::Process(Long64_t locEntry)
{
...
void DSelector_mc_pipkmks_recon::Finalize(void)
{
