#ifndef DSelector_mc_pipkmks_flat_h
#define DSelector_mc_pipkmks_flat_h
...
class DSelector_mc_pipkmks_flat : public DSelector
{
	public:

		DSelector_mc_pipkmks_flat(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_mc_pipkmks_flat(){}
	...
	ClassDef(DSelector_mc_pipkmks_flat, 0);
};

void DSelector_mc_pipkmks_flat::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_mc_pipkmks_flat_h
